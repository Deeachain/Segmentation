...
def parse_arguments():
    ...
    parser.add_argument('-c', '--config', default='config/cityscapes.json', type=str,
                        help='The config used to train the model')
    parser.add_argument('-mo', '--mode', default='multscale', type=str,
                        help='Mode used for prediction: either [multiscale, sliding]')
    parser.add_argument('-m', '--model', default='saved/PSPNet/07-13_11-06/best_model.pth', type=str,
                        help='Path to the .pth model checkpoint to be used in the prediction')
    parser.add_argument('-i', '--images', default='/media/ding/Data/datasets/cityscapes/leftImg8bit/test/bonn', type=str,
