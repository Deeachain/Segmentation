...
class BaseTrainer:
    def __init__(self, model, loss, resume, config, train_loader, val_loader=None, train_logger=None):
        ...
        self.checkpoint_dir = os.path.join(cfg_trainer['save_dir'], self.config['train_loader']['type'],
        ...
        writer_dir = os.path.join(cfg_trainer['log_dir'], self.config['train_loader']['type'], self.config['name'],
                                  start_time)
